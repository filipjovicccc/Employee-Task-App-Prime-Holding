...
function NewEmployee({onAddEmployee}) {
  ...
  return (
    ...
    <form className='form' onSubmit={submitTask}>
     ...
     <input type="text" value={birthDate} onChange={(e) => setBirthDate(e.target.value)} placeholder="Birth date" required />

     </div>
    <div className='form-control'>
      <label>Employee salary</label>
     <input type="date" value={salary} onChange={(e) => setSalary(e.target.value)} placeholder="Employee salary" required />
   </div>
